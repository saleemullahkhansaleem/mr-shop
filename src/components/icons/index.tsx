...
const SystemIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const SettingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    ...
    <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-.98 1.51v.1a2 2 0 0 1-4 0v-.1a1.65 1.65 0 0 0-.98-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-.98h-.1a2 2 0 0 1 0-4h.1a1.65 1.65 0 0 0 1.51-.98 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33h.1a1.65 1.65 0 0 0 .98-1.51v-.1a2 2 0 0 1 4 0v.1a1.65 1.65 0 0 0 .98 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82v.1a1.65 1.65 0 0 0 1.51.98h.1a2 2 0 0 1 0 4h-.1a1.65 1.65 0 0 0-1.51.98z" />
  </svg>
);
...
const ClothingIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    ...
    strokeLinejoin="round"
  >
    <path d="M4 7v13h16V7l-5-3H9l-5 3z" />
    <path d="M12 1l-2 6h4l-2-6z" />
  </svg>
);
...
const BeautyIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const SportsIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const AutomotiveIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const ToysGamesIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const BooksIcon: React.FC<IconProps> = (props) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M4 19.5a2.5 2.5 0 0 1 2.5-2.5h15.5" />
    <path d="M6 8.5h15.5v12.5H6a2.5 2.5 0 0 1 0-5z" />
    <path d="M10 3v13.5" />
    <path d="M14 3v13.5" />
    <path d="M18 3v13.5" />
  </svg>
...
const HealthIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
const OfficeSuppliesIcon: React.FC<IconProps> = (props) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
